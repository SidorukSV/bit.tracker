...
- Пространства (space) с владельцем и администраторами
- Команды (иерархия через `parent_team_id`) внутри пространства
...
- Видимость участников и команд ограничена рамками пространства
- Владелец/администратор пространства может создавать команды и удалять участников из любых команд/проектов
